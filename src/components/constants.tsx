...
export const CONTENT = {
  ...
  PROCESS: {
    ...
    BODY: (
      <>
        ...
        . Additionally, he collaborated with a Romanian composer named{" "}
        <b>Ana Maria Oancea</b> who contributed <b>unique soundtracks</b> for
        each animation based on <b>prompts</b>, thereby furthering the{" "}
        <b>primitive idea</b> closer to fruition. The duration of each animation
        is <b>60 seconds</b>. While AI served as a <b>tool</b>, the musician
        became a <b>collaborator</b>, highlighting the interplay between{" "}
        <b>programmatic</b> and <b>natural language.</b>
        <br />
  ...
  ARTIST: {
    ...
    BODY: (
      <>
        ...
        mural-making and street art in the western and Himalayan regions in
        India. The flame of democratizing art burned bright within him, while he
        worked with NGOs in painting street art for slum areas, local police
        headquarters, as well as co-creating what was considered the third
        longest street art in India at the time in 2017 (300ft x 15ft) for
        Reliance at the Mumbai Metro rail yard.
        <br />
        SNZ's most recent NFT release has been his series named{" "}
        <b>Butterfly Bubble</b> (2022). Inspired by <b>temporal themes</b>,
        SNZ’s earlier work tokenized as NFTs, speaks to the inevitability of
        time (<b>‘Patients of Time’</b> - April 2021), identifying ourselves (
        <b>‘OG SUGGA’</b> September 2020,
  ...
  JOURNEY: {
    ...
    BODY: (
      <>
        These <b>gems' refinement</b> is depicted through an increasing number of
